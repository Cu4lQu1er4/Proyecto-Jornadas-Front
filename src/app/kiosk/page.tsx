  ...
  export default function KioskPage() {
    ...
    return (
      <div className="min-h-screen bg-surface p-6 flex flex-col justify-between gap-6">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <span className="text-7xl font-bold tracking-wider text-black">
              {formatTime(now)}
            </span>
          </div>
          ...
          {status && (
            <motion.button
              ...
              disabled={loading}
              className={`w-full rounded-3xl py-10 text-3xl font-bold text-white transition
                ${
